  ...
  Widget _messagesListView() {
    ...
    if (_pageProvider.messages != null) {
      ...
      if (_pageProvider.messages!.isNotEmpty) {
        log(_pageProvider.messages!.length.toString());
        log("llllllllllllllllllllenght");
        return SizedBox(
  ...
  Widget _sendImageButton() {
    ...
    return SizedBox(
      ...
      child: FloatingActionButton(
        ...
        onPressed: () {
          log("tapedimageeeeeeeeeeeeeeeeeeeeeeeeeeeeeee");
